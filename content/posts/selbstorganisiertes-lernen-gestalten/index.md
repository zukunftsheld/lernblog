...
footnotes = "Die Inhalte in diesem Beitrag sind [Teil eines Konzepts](https://www.bensblog.ch/neues-lernen-fuer-eine-neue-arbeitswelt/), welches im Rahmen eines CAS-Moduls erstellt wurde. Die hier abgeblideten Inhalte wurden als Einstieg und Basis für eine Wissensmanagement und -Austausch Plattform (Confluence) erstellt, welche sich bei einer möglichen Praxisanwendung laufend kollaborativ mit Best Practice Beispielen entwickeln kann und soll.\n\n📚Passende Bücher dazu gibts in der [Bibliothek](https://www.bensblog.ch/cas_businessimpact_verzeichnis/)."
+++
...
![Lernmöglichkeiten im Team, Eigene Darstellung.](teamlernen.jpg)
